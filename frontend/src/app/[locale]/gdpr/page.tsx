			...
			<div className={styles.container}>
				...
				<ol className={styles.ol}>
					<li>
						...
						<p>
							Správcem osobních údajů je společnost FLOVAS s.r.o. Odpovídáme za
							to, aby vaše údaje byly zpracovávány zákonně, transparentně a
					...
					<li>
						...
						<ul className={styles.ul}>
							...
							<li>
								Po dobu trvání pracovního poměru a následně po dobu 10 let (dle
								archivačních lhůt daných českými zákony).
							</li>
							<li>
								3 roky na základě vašeho souhlasu (pro účely budoucích nabídek),
								pokud souhlas neodvoláte dříve.
							</li>
						</ul>
					</li>
					<li>
